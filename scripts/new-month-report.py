...
def main():
    ...
    report_banner = (f'<!-- REPORT-KIND BANNER — this is the {label} reporting-month report, generated from the master template. -->\n'
                     ...
                     f"  <span><strong>{label}</strong> — generated from the master template. All live figures are placeholders until Google Ads, GA4 and Kirsten's manual inputs are supplied. See <code>reports/{ym}/README.md</code>.</span>\n"
                     '</div>')
